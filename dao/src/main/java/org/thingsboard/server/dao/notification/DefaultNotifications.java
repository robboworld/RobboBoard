...
public class DefaultNotifications {
    ...
    public static final DefaultNotification newAlarm = DefaultNotification.builder()
            .name("Новое оповещение об ошибке")
            .type(NotificationType.ALARM)
            .subject("Новая ошибка '${alarmType}'")
            .text("Уровень: ${alarmSeverity}, источник: ${alarmOriginatorEntityType} '${alarmOriginatorName}'")
            ...
            .rule(DefaultRule.builder()
                    ...
                    .triggerConfig(AlarmNotificationRuleTriggerConfig.builder()
                            ...
                            .build())
                    .description("Отправлять уведомления администраторам арендаторов при возникновении ошибки")
                    .build())
            .build();
    public static final DefaultNotification alarmUpdate = DefaultNotification.builder()
            .name("Уведомление об обновлении ошибки")
            .type(NotificationType.ALARM)
            .subject("Ошибка '${alarmType}' - ${action}")
            .text("Уровень: ${alarmSeverity}, источник: ${alarmOriginatorEntityType} '${alarmOriginatorName}'")
            .icon("notifications").color(null)
            .rule(DefaultRule.builder()
                    .name("Обновление ошибки")
                    .triggerConfig(AlarmNotificationRuleTriggerConfig.builder()
                            .alarmTypes(null)
                            .alarmSeverities(null)
                            .notifyOn(Set.of(AlarmAction.SEVERITY_CHANGED, AlarmAction.ACKNOWLEDGED, AlarmAction.CLEARED))
                            .build())
                    .description("Отправлять уведомления администраторам арендаторов при обновлении или исчезновении ошибки")
                    .build())
            .build();
